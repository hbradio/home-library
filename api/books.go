...
func Books(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPost:
		...
		book, err := models.CreateBook(pool, user.ID, body.ISBN, body.Title, body.Author, body.Genre, body.Publisher, body.DeweyDecimal, body.LCClassification, body.PublishYear)
		if err != nil {
	...
	case http.MethodPut:
		...
		book, err := models.UpdateBook(pool, bookID, user.ID, body.Title, body.Author, body.Genre, body.Publisher, body.DeweyDecimal, body.LCClassification, body.DeweyGuess, body.LCGuess, body.CoverURL, body.PublishYear)
		if err != nil {
